...
export default function App() {
  ...
  useGSAP(
    ({ selector }) => {
      const floatingTargets = selector(".card img, .tip-post-image, .map-box iframe, .hero-showcase-jar");
      const floatingTargets = selector(".card img, .combo, .tip-post-image, .hero-showcase-jar");
